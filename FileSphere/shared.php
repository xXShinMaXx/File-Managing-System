        ...
        <main class="content">
            ...
            <div id="gridContainer" class="grid-view active">
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    echo "<h3>あなたと共有されたファイルはありません。</h3>";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // Font Awesome Free only ships the "regular" style
                        // for the generic fa-file icon. All of the
                        // type-specific icons below (fa-file-pdf, etc.)
                        // only exist in the "solid" style, so the icon
                        // style has to switch along with the icon itself.
                        $icon = "fa-file";
                        ...
                        <div class="file-card">
                            ...
                            <p>
                                ...
                                <?php echo htmlspecialchars($owner); ?>さんが共有
