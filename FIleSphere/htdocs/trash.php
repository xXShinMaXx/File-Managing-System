                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="file-card" data-name="<?php echo strtolower($file); ?>">
                            ...
                            <div class="card-buttons">
                                ...
                                <a href="restoretrash.php?id=<?php echo $row['id']; ?>" class="btn-restore">
                                ...
                                <a href="deleteforever.php?id=<?php echo $row['id']; ?>" class="btn-delete"
